...
To run this temporary DEMO, you must open a terminal to backend\api\products and run dotnet run to launch .NET API locally. You will open the REACT app in a separate terminal and run npm install > npm run dev to launch the React app.
